...
public class DateFormatter implements IDateFormatter {
    ...
    public DateFormatter(Date time) {
        this.time = time;
    }
    ...
    public static void main(String[] args) throws JokeException {
        ...
        System.out.println(new DateFormatter(new Date()).getFormattedDate("Europe/Kiev"));

        System.out.println(new DateFormatter(new Date()).getFormattedDate("ImNotLegal"));
